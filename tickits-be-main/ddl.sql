...
-- public.theater_studio definition
-- Drop table
-- DROP TABLE public.theater_studio;
CREATE TABLE public.theater_studio (
    id int8 NOT NULL GENERATED BY DEFAULT AS IDENTITY(
        INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1 NO CYCLE
    ),
    ...
    price int8 NULL,
    movie_id uuid NULL,
    CONSTRAINT theater_studio_pkey PRIMARY KEY (id),
    CONSTRAINT theater_studio_movie_id_fkey FOREIGN KEY (movie_id) REFERENCES public.movies(id) ON DELETE CASCADE,
    CONSTRAINT theater_studio_theater_id_fkey FOREIGN KEY (theater_id) REFERENCES public.theaters(id) ON DELETE CASCADE
);
...
CREATE TABLE public.history (
    ...
    CONSTRAINT history_theatstudio_id_fkey FOREIGN KEY (theatstudio_id) REFERENCES public.theater_studio(id),
